...
def run(argv=None):
  ...
  with beam.Pipeline(options=pipeline_options) as p:
    if known_args.source == 'text':
        ...
        consumer_config = {"topic": known_args.input,'bootstrap_servers':'pkc-6ojv2.us-west4.gcp.confluent.cloud:9092',\
            'security_protocol':'SASL_SSL','sasl_mechanism':'PLAIN','sasl_plain_username':'FX27LOX2Y5Q5TK7R',\
            'sasl_plain_password':"wyiT5uB736jgiwG9jLlnAZxNJBh7/3HNU2Kdhd6txRZQDxj/CoUZPuwQg+6X6xED",\
